    ...
    <div id="wrapper">
        <div id="extra" class="container">
            ...
            <form method="POST" action="/cvs/{{ $cv->id }}">
                    ...
                    <div class="form-row">
                        <div class="form-group col">
                            <input type="text" class="form-control @error('name') is-invalid @enderror"
                                placeholder="First name" name="name" value="{{ $cv->name }}" required>
                            @error('name')
                        ...
                        <div class="form-group col">
                            <input type="text" class="form-control @error('surname') is-invalid @enderror"
                                placeholder="Last name" name="surname" value="{{ $cv->surname }}" required>
                            @error('surname')
                    ...
                    <div class="form-row">
                        <div class="col">
                            ...
                            <input type="email" class="form-control @error('email') is-invalid @enderror" id="email"
                                name="email" value={{ $cv->email }} required>
                            @error('email')
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="string" class="form-control @error('phone') is-invalid @enderror" id="phone"
                                name="phone" value={{ $cv->phone }} required>
                            @error('phone')
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="apartment" name="apartment"
                            placeholder="Apartment, studio, or floor" value="{{ $address->apartment }}">
                        @error('apartment')
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="institution_name" name="institution_name[]"
                                        placeholder="University Of Zimbabwe" value="{{ $institution->institution_name }}"
                                        required>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="faculty" name="faculty[]"
                                        placeholder="The Faculty of Arts" value="{{ $institution->faculty }}" required>
                                    @error('faculty')
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="study_program" name="study_program[]"
                                        placeholder="" value="{{ $institution->study_program }}" required>
                                    @error('study_program')
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="degree" name="degree[]"
                                        placeholder="Bachelor's,Master's.." value="{{ $institution->degree }}" required>
                                    @error('degree')
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="years_studied" name="years_studied[]"
                                        placeholder="" value="{{ $institution->years_studied }}" required>
                                    @error('years_studied')
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="status" name="status[]"
                                        placeholder="Finished, In progress.." value="{{ $institution->status }}" required>
                                    @error('status')
                ...
                <div id="workplace_container">
                    <h3>Work Experience</h3>
                    <button type="button" class="btn btn-warning" id="addWorkplace">
                        Add more
                    </button>
                        ...
                        <div id="single_workplace">
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="company_name" name="company_name[]"
                                        placeholder="" value="{{ $workplace->company_name }}" required>
                                    @error('company_name')
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="position" name="position[]" placeholder=""
                                        value="{{ $workplace->position }}" required>
                                    @error('position')
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="schedule" name="schedule[]" placeholder=""
                                        value="{{ $workplace->schedule }}" required>
                                    @error('schedule')
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="years_worked" name="years_worked[]"
                                        placeholder="" value="{{ $workplace->years_worked }}" required>
                                    @error('years_worked')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="description" name="description[]" placeholder=""
                                    value="{{ $workplace->description }}" required>
                                @error('description')
